    ...
    if (numberOfClickedEvaluationItems < parseInt(numberOfRenderedEvaluationItems)) {
        ...
        bootbox.confirm("You did not evaluate all items. Are you sure you want to <b>continue</b>?", function (result) {
            if (result) {
                ...
                bootbox.prompt({
                    title: "Please enter your password to confirm your EVALUATION action:",
                    inputType: 'password',
                    callback: function (result) {
                        ...
                        if (result == "" || result == null) {
                            ...
                            Url = Url + "?evaluationTemplateItems=" + EvaluationItemList + "&overAllGradeId=" + overAllGradeId + "&traineeId=" + traineeId + "&traineeId=" + traineeId + "&lessonId=" + lessonId + "&remark=" + remark + "&password=" + result + "&fylingFTDScheduleId=" + fylingFTDScheduleId
                            location.href = Url;
